...
class CXboxPropertySheet : public IXboxVisitor
{
  ...
  private:
    ...
    static DWORD WINAPI ThreadProcStart(LPVOID pvThis) {return ((CXboxPropertySheet *)pvThis)->ThreadProc();}
    DWORD ThreadProc();
...
--*/
{
    ...
    protected:
      ...
      static DWORD WINAPI StartThreadProc(PVOID pvThis) {return ((CFSItemGeneralPage *)pvThis)->ThreadProc();}
      DWORD ThreadProc();
