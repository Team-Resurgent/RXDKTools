...
INT_PTR CALLBACK CWizardPage::DialogProc(HWND hWndDlg, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    pThis = (CWizardPage *)(LONG_PTR)XdkGetDlgUser(hWndDlg);
    if(pThis)
    {
        switch(uMsg)
        {
...
INT_PTR CAddConsoleGetName::OnWizNext()
{
    ...
    if(!m_pAddConsoleData->GetIpAddress(&dwIpAddress))
    {
        ...
        XdkSetDlgMsgResult(m_hPageDlg, IDD_ADDCONSOLE_GETNAME);
    } else
    {
        XdkSetDlgMsgResult(m_hPageDlg, m_pAddConsoleData->ShowAccessDenied() ? IDD_ADDCONSOLE_ACCESSDENIED : IDD_ADDCONSOLE_MAKEDEFAULT);
    }
    return TRUE;
}
...
{
    XdkSetDlgMsgResult(m_hPageDlg, IDD_ADDCONSOLE_WELCOME);
    return TRUE;
}
...
INT_PTR CAddConsoleAccessDenied::OnWizNext()
{
    ...
    if(SUCCEEDED(hr))
    {
        XdkSetDlgMsgResult(m_hPageDlg, IDD_ADDCONSOLE_MAKEDEFAULT);
    } else
    {
        ...
        XdkSetDlgMsgResult(m_hPageDlg, IDD_ADDCONSOLE_ACCESSDENIED);
    }
    return TRUE;    
}
...
INT_PTR CAddConsoleMakeDefault::OnWizNext()
{
    ...
    XdkSetDlgMsgResult(m_hPageDlg, IDD_ADDCONSOLE_FINISH);
    return TRUE;
}

INT_PTR CAddConsoleMakeDefault::OnWizBack()
{
    XdkSetDlgMsgResult(m_hPageDlg, m_pAddConsoleData->ShowAccessDenied() ? IDD_ADDCONSOLE_ACCESSDENIED : IDD_ADDCONSOLE_GETNAME);
    return TRUE;
}
