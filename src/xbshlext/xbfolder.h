    ...
    CTRACKABLEOBJECT
{
  ...
  */
  ...
  virtual HRESULT GetColumnSCID(IN UINT iColumn, OUT SHCOLUMNID *pscid){return E_NOTIMPL;}
  virtual UINT GetColumnCount(){return 0;}
  ...
  */
  ...
  HRESULT CompareItemIDs(UINT iColumn, int iNameCmp, const __unaligned SHITEMID *pItem1, const __unaligned SHITEMID *pItem2);
...
class CXboxRoot : public CXboxFolder, public CComCoClass<CXboxRoot, &CLSID_XboxFolder>
{
  ...
  */
  ...
  virtual HRESULT GetColumnSCID(UINT iColumn, SHCOLUMNID *pscid);
  ...
  */
  ...
  #define XBOX_USE_USER_PROVIDED_NAME ((LPSTR)(UINT_PTR)0xFFFFFFFF)
