...
#if !defined(XNET_BUILD_LIBX) && !defined(XNET_BUILD_LIBXS) && !defined(XNET_BUILD_LIBM) && !defined(XNET_BUILD_LIBO) && !defined(XNET_BUILD_LIBOS) && !defined(XNET_BUILD_LIBXW) && !defined(XNET_BUILD_LIBOW) && !defined(XONLINE_BUILD_LIBX) && !defined(XONLINE_BUILD_LIBS)
    XNETAPILIST()
    SOCKAPILIST()
    HALAPILIST()
#endif
