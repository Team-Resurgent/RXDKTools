...
#ifdef _WIN64
#include "xbox86ctx.h"
typedef XBOX86_FLOATING_SAVE_AREA FLOATING_SAVE_AREA;
#endif
#define _XBDM_
#include <xboxdbg.h>
#include <stdio.h>
...
/* Original XDK winnt.h placed Cr0NpxState after RegisterArea; modern SDK omits it. */
#ifndef XbdmFloatCr0NpxState
#define XbdmFloatCr0NpxStatePtr(pfs) \
    ((DWORD *)((BYTE *)(pfs) + offsetof(FLOATING_SAVE_AREA, RegisterArea) + SIZE_OF_80387_REGISTERS))
#define XbdmFloatCr0NpxState(pfs) (*XbdmFloatCr0NpxStatePtr(pfs))
#endif
