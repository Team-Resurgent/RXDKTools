    ...
    )
{
    ...
    for (Index = 0; Index < ImageHeader->NumberOfSections; Index++) {
        ...
        printf("%s%08lX head shared page reference count address\n", ImgbDumpPadding, ImgbDumpAddress((ULONG_PTR)ImageSection->HeadSharedPageReferenceCount));
    ...
    )
{
    ...
    printf("%s%08lX base address\n", ImgbDumpPadding, ImgbDumpAddress((ULONG_PTR)ImageHeader->BaseAddress));
    ...
    printf("%s%08lX certificate address\n", ImgbDumpPadding, ImgbDumpAddress((ULONG_PTR)ImageHeader->Certificate));
    ...
    printf("%s%08lX original base address\n", ImgbDumpPadding, ImgbDumpAddress((ULONG_PTR)ImageHeader->NtBaseOfDll));
    printf("%s%8X original size of image\n", ImgbDumpPadding, ImageHeader->NtSizeOfImage);
    printf("%s%08lX original checksum\n", ImgbDumpPadding, ImgbDumpAddress((ULONG_PTR)ImageHeader->NtCheckSum));
    ...
    printf("%s%08lX debug path name address\n", ImgbDumpPadding, ImgbDumpAddress((ULONG_PTR)ImageHeader->DebugPathName));
    printf("%s%08lX debug file name address\n", ImgbDumpPadding, ImgbDumpAddress((ULONG_PTR)ImageHeader->DebugFileName));
    printf("%s%08lX debug Unicode file name address\n", ImgbDumpPadding, ImgbDumpAddress((ULONG_PTR)ImageHeader->DebugUnicodeFileName));
    printf("%s%08lX kernel image thunk address\n", ImgbDumpPadding, ImgbDumpAddress((ULONG_PTR)ImageHeader->XboxKernelThunkData));
    printf("%s%08lX non-kernel import directory address\n", ImgbDumpPadding, ImgbDumpAddress((ULONG_PTR)ImageHeader->ImportDirectory));
    printf("%s%8X number of library versions\n", ImgbDumpPadding, ImageHeader->NumberOfLibraryVersions);
    printf("%s%08lX library versions address\n", ImgbDumpPadding, ImgbDumpAddress((ULONG_PTR)ImageHeader->LibraryVersions));
    printf("%s%08lX kernel library version address\n", ImgbDumpPadding, ImgbDumpAddress((ULONG_PTR)ImageHeader->XboxKernelLibraryVersion));
    printf("%s%08lX XAPI library version address\n", ImgbDumpPadding, ImgbDumpAddress((ULONG_PTR)ImageHeader->XapiLibraryVersion));
    printf("%s%08lX logo bitmap address\n", ImgbDumpPadding, ImgbDumpAddress((ULONG_PTR)ImageHeader->MicrosoftLogo));
